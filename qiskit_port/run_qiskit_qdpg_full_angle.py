...
def main():
    ...
    # Use full original asset universe and full dataset.
    print("Qiskit run price_data shape:", price_data.shape)

    metrics_module.tickers = list(price_data.columns)
    print("Qiskit run tickers:", metrics_module.tickers)
    ...
    model.train(
        ...
        soft_update=False,
        num_epochs=1, #remeber to change to 50 to match paper
